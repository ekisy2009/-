...
1. המשתמש מעלה תמונה של תפריט ספק  
2. התמונה מומרת ל-Base64  
3. נשלחת בקשה ל-Claude Vision API  
4. המודל מחזיר JSON בפורמט קשיח  
5. מתבצעת בדיקת תקינות (Validation) בצד הלקוח  
6. הנתונים מוצגים בטבלה וניתנים לעריכה לפני אישור (Human-in-the-loop)
